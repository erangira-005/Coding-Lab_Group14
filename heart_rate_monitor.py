...
# This is where all heart rate log files will be stored
...
try:
    while True:
        ...
        heart_rate = random.randint(60, 100)           # Random heart rate between 60-100 bpm
...
# -----------------------------
# COMMENT 5: Handle user stopping the script
